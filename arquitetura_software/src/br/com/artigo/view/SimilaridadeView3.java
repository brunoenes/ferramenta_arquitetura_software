...
public class SimilaridadeView3 extends JFrame {

	/**
	 * 
	 */
	private static final long serialVersionUID = 6570197841181687353L;
	...
	public static void main(String[] args) {
		EventQueue.invokeLater(new Runnable() {
			public void run() {
				try {
					SimilaridadeView3 window = new SimilaridadeView3(null,null);
	...
	public SimilaridadeView3(ArrayList<InfoPacote> pacotes, ArrayList<InfoPacote> alterados) {
		this.pacotes = alterados;
		initialize();
	}
	...
	private void initialize() {
		...
		if (pacotes != null) {
			...
			for (InfoPacote infoPacote : pacotes) {
				...
				Circulo circulo = new Circulo(Color.decode(infoPacote.getClassePadrao().getPaletaAtual().getC100()),
